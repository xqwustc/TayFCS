...
if __name__ == '__main__':
    ...
    parser.add_argument('--K', type=lambda x: [int(i) for i in x.split(',')], required=True, help='The number of selected features (comma-separated, single value also allowed).')
