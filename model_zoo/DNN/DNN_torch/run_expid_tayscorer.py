...
if __name__ == '__main__':
    ...
    # Save metrics to experiment-specific path to avoid overwriting across runs
    exp_metric_path = os.path.join(data_dir, f'exp_metric_{experiment_id}.pkl')
    with open(exp_metric_path, 'wb') as f:
